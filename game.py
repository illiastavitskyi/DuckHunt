        ...
        if self.state == "menu":
            ...
            self.window.blit(
                ...
                (
                    ...
                    - go_text.get_height() // 2
                )
            )

            round_text = self.font_small.render(
                (
                    f"Rounds: {self.selected_rounds} "
                    f"(press 1-5 on keyboard)"
                ),
                True,
                (255, 255, 255)
            )
